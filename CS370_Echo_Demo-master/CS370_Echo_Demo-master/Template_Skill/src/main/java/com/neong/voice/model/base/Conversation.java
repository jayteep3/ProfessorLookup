package com.neong.voice.model.base;
...
import com.neong.voice.model.interfaces.ConversationInterface;
...
public class Conversation implements ConversationInterface {
	...
	/*
	 * The () method below should be Overridden in your subclass to
	 * service the routed intents.
	*/
	@Override
	public SpeechletResponse respondToIntentRequest(IntentRequest intentReq, Session session) {
		log.error(" called within Conversation superclass.");
